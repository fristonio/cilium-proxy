...
type PortNetworkPolicyRule struct {
	...
	// A set of remote identities selectors that will be resolved from identity selector
	// discovery service and used in union with remote_policies.
	RemoteSelectors []uint64 `protobuf:"varint,11,rep,packed,name=remote_selectors,json=remoteSelectors,proto3" json:"remote_selectors,omitempty"`
...
func (x *PortNetworkPolicyRule) GetRemoteSelectors() []uint64 {
	if x != nil {
		return x.RemoteSelectors
	}
	return nil
}
...
const file_cilium_api_npds_proto_rawDesc = "" +
	...
	"\x0ealpn_protocols\x18\a \x03(\tR\ralpnProtocols\"\xe8\x04\n" +
	...
	"\x0fremote_policies\x18\a \x03(\rR\x0eremotePolicies\x12)\n" +
	"\x10remote_selectors\x18\v \x03(\x04R\x0fremoteSelectors\x12H\n" +
	...
	"\x15StreamNetworkPolicies\x12,.envoy.service.discovery.v3.DiscoveryRequest\x1a-.envoy.service.discovery.v3.DiscoveryResponse\"\x00(\x010\x01\x12\x83\x01\n" +
	"\x14DeltaNetworkPolicies\x121.envoy.service.discovery.v3.DeltaDiscoveryRequest\x1a2.envoy.service.discovery.v3.DeltaDiscoveryResponse\"\x00(\x010\x01\x12\x9e\x01\n" +
...
var file_cilium_api_npds_proto_goTypes = []any{
	...
	(*v33.DeltaDiscoveryRequest)(nil),  // 19: envoy.service.discovery.v3.DeltaDiscoveryRequest
	(*v33.DiscoveryResponse)(nil),      // 20: envoy.service.discovery.v3.DiscoveryResponse
	(*v33.DeltaDiscoveryResponse)(nil), // 21: envoy.service.discovery.v3.DeltaDiscoveryResponse
}
var file_cilium_api_npds_proto_depIdxs = []int32{
	...
	19, // 21: cilium.NetworkPolicyDiscoveryService.DeltaNetworkPolicies:input_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
	18, // 22: cilium.NetworkPolicyDiscoveryService.FetchNetworkPolicies:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	20, // 23: cilium.NetworkPolicyDiscoveryService.StreamNetworkPolicies:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	21, // 24: cilium.NetworkPolicyDiscoveryService.DeltaNetworkPolicies:output_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
	20, // 25: cilium.NetworkPolicyDiscoveryService.FetchNetworkPolicies:output_type -> envoy.service.discovery.v3.DiscoveryResponse
...
func (c *networkPolicyDiscoveryServiceClient) DeltaNetworkPolicies(ctx context.Context, opts ...grpc.CallOption) (NetworkPolicyDiscoveryService_DeltaNetworkPoliciesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NetworkPolicyDiscoveryService_serviceDesc.Streams[1], "/cilium.NetworkPolicyDiscoveryService/DeltaNetworkPolicies", opts...)
	if err != nil {
		return nil, err
	}
...
type NetworkPolicyDiscoveryService_DeltaNetworkPoliciesClient interface {
	Send(*v33.DeltaDiscoveryRequest) error
	Recv() (*v33.DeltaDiscoveryResponse, error)
	grpc.ClientStream
}
...
func (x *networkPolicyDiscoveryServiceDeltaNetworkPoliciesClient) Send(m *v33.DeltaDiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *networkPolicyDiscoveryServiceDeltaNetworkPoliciesClient) Recv() (*v33.DeltaDiscoveryResponse, error) {
	m := new(v33.DeltaDiscoveryResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (*UnimplementedNetworkPolicyDiscoveryServiceServer) DeltaNetworkPolicies(NetworkPolicyDiscoveryService_DeltaNetworkPoliciesServer) error {
	return status.Errorf(codes.Unimplemented, "method DeltaNetworkPolicies not implemented")
}
...
type NetworkPolicyDiscoveryService_DeltaNetworkPoliciesServer interface {
	Send(*v33.DeltaDiscoveryResponse) error
	Recv() (*v33.DeltaDiscoveryRequest, error)
	grpc.ServerStream
}
...
func (x *networkPolicyDiscoveryServiceDeltaNetworkPoliciesServer) Send(m *v33.DeltaDiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *networkPolicyDiscoveryServiceDeltaNetworkPoliciesServer) Recv() (*v33.DeltaDiscoveryRequest, error) {
	m := new(v33.DeltaDiscoveryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
