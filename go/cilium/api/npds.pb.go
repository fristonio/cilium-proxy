...
type PortNetworkPolicyRule struct {
	...
	// Regex pattern here only validates valid DNS characters in the string.
	// This is aligned with validation pattern of k8s type in cilium/cilium.
...
const file_cilium_api_npds_proto_rawDesc = "" +
	...
	"\x0ealpn_protocols\x18\a \x03(\tR\ralpnProtocols\"\xe2\x04\n" +
	...
	"\x14upstream_tls_context\x18\x04 \x01(\v2\x12.cilium.TLSContextR\x12upstreamTlsContext\x12F\n" +
	"\fserver_names\x18\x06 \x03(\tB#\xfaB \x92\x01\x1d\"\x1br\x192\x17^([-a-zA-Z0-9_*]+[.]?)+R\vserverNames\x12\x19\n" +
